...
contract FlightSuretyApp {
    ...
    // Helper: Register Airline
    function _registerAirline(string airlineName, address airlineAddress)
        private
    {
        flightSuretyData.registerAirline(airlineName, airlineAddress);
    }

    // Helper: return airline registered
    ...
    // Helper: return airline pending
    function isAirlinePending(address airlineAddress)
        external
        view
        requireIsOperational
        returns (bool)
        ...
        requireIsOperational
    {
        ...
        require(
            flightSuretyData.isAirlineFunded(airlineAddress) == false,
    ...
    // after oracle has updated flight status
